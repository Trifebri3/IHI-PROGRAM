...
<footer class="bg-white border-t border-emerald-100 mt-auto">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="py-6 md:flex md:items-center md:justify-between">

            <!-- Link Bantuan & Kebijakan (Muncul di tengah pada mobile, di kanan pada desktop) -->
            <div class="flex justify-center mb-4 space-x-6 md:order-2 md:mb-0">
                <a href="#" class="text-sm font-medium text-gray-500 transition-colors hover:text-emerald-600">
                    Pusat Bantuan
                </a>
                <a href="#" class="text-sm font-medium text-gray-500 transition-colors hover:text-emerald-600">
                    Kebijakan Privasi
            ...
            <!-- Versi Sistem (Kanan ujung pada desktop, disembunyikan di mobile agar rapi) -->
