    ...
    <div class="space-y-7 flex-1 overflow-y-auto pr-1">
        ...
        <div>
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{ \Illuminate\Support\Facades\Route::has('superadmin.program-participants.index') ? route('superadmin.program-participants.index') : url('/superadmin/program-participants') }}"
                       class="flex items-center px-3.5 py-2.5 text-sm font-semibold rounded-xl transition-all group {{ request()->is('superadmin/program-participants*') || request()->routeIs('superadmin.program-participants.*') ? 'bg-gradient-to-r from-emerald-50 to-emerald-100/30 text-emerald-900 border-l-4 border-emerald-600 shadow-sm' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-800' }}">
                        <svg class="w-5 h-5 mr-3 transition-colors {{ request()->is('superadmin/program-participants*') || request()->routeIs('superadmin.program-participants.*') ? 'text-emerald-700' : 'text-slate-400 group-hover:text-emerald-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                        <span>Partisipan Program</span>
                    </a>
                </li>
        ...
        <div>
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="{{ \Illuminate\Support\Facades\Route::has('superadmin.database-backups.index') ? route('superadmin.database-backups.index') : url('/superadmin/database-backups') }}"
                       class="flex items-center px-3.5 py-2.5 text-sm font-semibold rounded-xl transition-all group {{ request()->is('superadmin/database-backups*') || request()->routeIs('superadmin.database-backups.*') ? 'bg-gradient-to-r from-emerald-50 to-emerald-100/30 text-emerald-900 border-l-4 border-emerald-600 shadow-sm' : 'text-slate-600 hover:bg-slate-50 hover:text-emerald-800' }}">
                        <svg class="w-5 h-5 mr-3 transition-colors {{ request()->is('superadmin/database-backups*') || request()->routeIs('superadmin.database-backups.*') ? 'text-emerald-700' : 'text-slate-400 group-hover:text-emerald-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
