    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('editorApp', () => ({
            ...
            async renderPage(pageNum) {
                ...
                // Reset transform to avoid upside-down rendering on same-size canvas reuse
            ...
            restorePageFromMemory(pageNum) {
                ...
                elements.forEach(el => {
                    ...
                    if (el.type === 'image' || el.type === 'qr_code') {
                        ...
                        // Text element
                        let fontPx = el.font_size * this.zoomLevel; 
            ...
            extractElements() {
                ...
                return objects.map(obj => {
                    ...
                    if (obj.type === 'i-text') {
                        font_pt = font_pt / this.zoomLevel;
                    }
            ...
            addText(text, typeName) {
                const textObj = new fabric.IText(text, {
                    ...
                    top: 50,
                    fontFamily: 'Arial',
                    fontSize: 24 * this.zoomLevel, // pixel
                    fill: '#000000',
                    originX: 'left',
                    originY: 'top',
                    textAlign: 'left'
            ...
            onObjectSelected(e) {
                ...
                if (obj.type === 'i-text') {
                    ...
                    this.objFontSize = Math.round(obj.fontSize / this.zoomLevel);
