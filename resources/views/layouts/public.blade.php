...
<a href="https://e-learning.instituthijauindonesia.or.id/speakers" class="block px-3 py-2 rounded-lg text-base font-semibold text-slate-600 hover:bg-slate-50 hover:text-emerald-600">
    Narasumber & Tim
            ...
            <div class="pt-4 border-t border-slate-100 flex flex-col gap-2">
                <a href="{{ route('login') }}" class="block text-center px-3 py-2.5 rounded-xl text-base font-bold text-slate-700 bg-slate-50 hover:bg-slate-100">
                    Masuk
                </a>
                <a href="https://e-learning.instituthijauindonesia.or.id/" target="_blank" class="block text-center px-3 py-2.5 rounded-xl text-base font-bold text-white bg-emerald-600 hover:bg-emerald-700 shadow-xs">
                    E-Learning
                </a>
            </div>
        </div>
